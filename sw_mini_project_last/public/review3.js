...
document.getElementById('review-form').addEventListener('submit', function(event) {
    ...
    if (reviewText) {
        ...
        const reviews = JSON.parse(localStorage.getItem('transformers_reviews')) || [];
        reviews.push(newReview);
        localStorage.setItem('transformers_reviews', JSON.stringify(reviews));
    ...
    reviews.forEach(review => {
        ...
        commentForm.addEventListener('submit', function(event) {
            ...
            if (commentText) {
                ...
                localStorage.setItem('transformers_reviews', JSON.stringify(updatedReviews));
                displayReviews();
            } else {
...
function sortReviews(order) {
    let reviews = JSON.parse(localStorage.getItem('transformers_reviews')) || [];
